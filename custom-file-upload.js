...
function addFileContainer(widgetName) {
    ...
    $(".filenames").append('<span class="' + widgetName + ' img_container"> <img id="img_' + widgetName + '" src=' + fileThumbnail + '><div>' + fileName + '<span id="delete_' + widgetName + '" style="font-weight:bold;" class="delete_file">4</span></div></span>');
